;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;
;; Miscelaneous routines for sprites made by imamelia.
;;
;; ----------------------------------------------------------------------
;;
;; SolidSprite
;;	Makes a sprite solid (can also be a platform).
;;
;; Input:
;;	A = Area size, format yyyyxxxx
;;	Carry = Crush > CLC = Don't Crush, SEC = Crush
;;	$190F = Highest bit makes this a platform.
;;
;; Output:
;; 	$8A = Contact information, format yx--rlbt
;; 		t = touching top
;; 		b = touching bottom
;; 		l = touching left side
;; 		r = touching right side
;; 		x = in the middle X range
;; 		y = in the middle Y range
...
;;	Checks for contact between whatever two things were set up
;;	previously.
;;
;; Input:
;;	$00-$07 = Clipping set 1
;;	$08-$0F = Clipping set 2
;; 
;; Output:
;;	Carry clear = No contact
;;	Carry set = Contact
;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
