...
!cat_suit_tile		= $00	;Tile used by the unused powerup E item
!cat_suit_prop		= $00	;YXPPCCCT properties of unused powerup E item
				;You may want to change the .cfg file too.

%powerup_number(cat_suit,0C)	;Mandatory macro to get the powerup number.
