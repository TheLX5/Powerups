...
YPlacement:
db $00,$F0	; Remember: $01-$7F moves the sprite to the bottom and $80-$FF to the top.
...
print "A block which spawns by default a mushroom if Mario is small, else a propeller mushroom."