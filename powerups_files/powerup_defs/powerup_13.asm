...
!unused_13_tile		= $0E	;Tile used by this powerup item.
!unused_13_prop		= $04	;YXPPCCCT properties of this powerup item.
				;You may want to change the .cfg file too.

!unused_13_dynamic_tile	= $4A	;Dynamic tile used by this powerup item.


%powerup_number(unused_13,13,Smoke)	;Mandatory macro to get the powerup number.
