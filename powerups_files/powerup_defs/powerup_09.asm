...
!superball_activate_delete	= 0	;Set to 1 to delete superballs when activating the blocks below.

!superball_activate_on_off	= 0	;Set to 1 to enable superballs be able to active ON/OFF blocks on contact.

!superball_activate_turn_block	= 0	;Set to 1 to enable superballs be able to active turn blocks on contact.
					;Set to 2 to enable superballs be able to break turn blocks on contact.

!superball_activate_throw_block	= 0	;Set to 1 to enable superballs be able to break throw blocks on contact.

!superball_activate_glass_block	= 0	;Set to 1 to enable superballs be able to active glass blocks on contact.

!superball_collect_coins	= 1	;Set to 1 to enable superballs be able to collect coins.
...
%powerup_number(superball,09,Palette)	;Mandatory macro to get the powerup number.
