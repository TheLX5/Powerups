...
!bubble_activate_on_off		= 0	;Set to 1 to enable bubbles be able to active ON/OFF blocks on contact.

!bubble_activate_turn_block	= 0	;Set to 1 to enable bubbles be able to active turn blocks on contact.
					;Set to 2 to enable bubbles be able to break turn blocks on contact.

!bubble_activate_throw_block	= 0	;Set to 1 to enable bubbles be able to break throw blocks on contact.

!bubble_activate_glass_block	= 0	;Set to 1 to enable bubbles be able to active glass blocks on contact.

!bubble_collect_coins		= 0	;Set to 1 to enable bubbles be able to collect coins.
